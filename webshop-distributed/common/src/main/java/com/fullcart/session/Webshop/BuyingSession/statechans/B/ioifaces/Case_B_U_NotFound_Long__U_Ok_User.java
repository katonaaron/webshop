...
public interface Case_B_U_NotFound_Long__U_Ok_User<__Succ1 extends Succ_In_U_NotFound_Long, __Succ2 extends Succ_In_U_Ok_User> extends In_U_NotFound_Long<__Succ1>, In_U_Ok_User<__Succ2> {
	Branch_B_U_NotFound_Long__U_Ok_User<?, ?> cast = null;

	Branch_B_U_NotFound_Long__U_Ok_User.Branch_B_U_NotFound_Long__U_Ok_User_Enum getOp();
