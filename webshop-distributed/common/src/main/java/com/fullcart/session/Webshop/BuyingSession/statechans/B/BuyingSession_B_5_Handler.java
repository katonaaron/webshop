...
public interface BuyingSession_B_5_Handler extends Handle_B_U_NotFound__U_Ok_User<BuyingSession_B_10, BuyingSession_B_6> {
	...
	@Override
    void receive(BuyingSession_B_10 schan, NotFound op) throws org.scribble.main.ScribRuntimeException, java.io.IOException, ClassNotFoundException;
}
