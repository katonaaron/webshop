...
import com.fullcart.session.Webshop.UserSession.statechans.C.ioifaces.Handle_C_U_Created_User__U_Err_String__U_Ok_User;

public interface UserSession_C_6_Handler extends Handle_C_U_Created_User__U_Err_String__U_Ok_User<UserSession_C_1, UserSession_C_1, UserSession_C_1> {
	...
	@Override
    void receive(UserSession_C_1 schan, Created op, org.scribble.runtime.util.Buf<com.fullcart.dto.UserDTO> arg1) throws org.scribble.main.ScribRuntimeException, java.io.IOException, ClassNotFoundException;
