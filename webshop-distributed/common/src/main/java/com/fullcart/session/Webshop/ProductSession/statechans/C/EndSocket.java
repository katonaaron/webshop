...
import com.fullcart.session.Webshop.ProductSession.statechans.C.ioifaces.Succ_Out_P_Bye;

public final class EndSocket extends org.scribble.runtime.statechans.EndSocket<ProductSession, C> implements Succ_Out_P_Bye {
