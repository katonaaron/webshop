...
import com.fullcart.session.Webshop.BuyingSession.statechans.B.ioifaces.Case_B_P_NotFound_Long__P_Ok_List;

public final class BuyingSession_B_7_Cases extends org.scribble.runtime.statechans.CaseSocket<BuyingSession, B> implements Case_B_P_NotFound_Long__P_Ok_List<BuyingSession_B_9, BuyingSession_B_8> {
	public static final BuyingSession_B_7_Cases cast = null;
	public final BuyingSession_B_7.Branch_B_P_NotFound_Long__P_Ok_List_Enum op;
	private final org.scribble.runtime.message.ScribMessage m;

	protected BuyingSession_B_7_Cases(org.scribble.runtime.session.SessionEndpoint<BuyingSession, B> se, boolean dummy, BuyingSession_B_7.Branch_B_P_NotFound_Long__P_Ok_List_Enum op, org.scribble.runtime.message.ScribMessage m) {
		super(se);
		this.op = op;
		this.m = m;
	}
	...
	public BuyingSession_B_9 receive(P role, NotFound op, org.scribble.runtime.util.Buf<? super java.lang.Long> arg1) throws org.scribble.main.ScribRuntimeException, java.io.IOException, ClassNotFoundException {
		super.use();
	...
	public BuyingSession_B_9 receive(NotFound op, org.scribble.runtime.util.Buf<? super java.lang.Long> arg1) throws org.scribble.main.ScribRuntimeException, java.io.IOException, ClassNotFoundException {
		return receive(BuyingSession.P, op, arg1);
	}
	...
	@Override
	public Branch_B_P_NotFound_Long__P_Ok_List.Branch_B_P_NotFound_Long__P_Ok_List_Enum getOp() {
		return this.op;
	}
}
