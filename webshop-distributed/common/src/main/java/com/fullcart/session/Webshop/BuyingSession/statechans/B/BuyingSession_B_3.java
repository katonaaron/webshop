...
import com.fullcart.session.Webshop.BuyingSession.statechans.B.ioifaces.Select_B_C_NotFound__C_Ok_Order;

import java.io.IOException;

public final class BuyingSession_B_3 extends org.scribble.runtime.statechans.OutputSocket<BuyingSession, B> implements Select_B_C_NotFound__C_Ok_Order<BuyingSession_B_1, BuyingSession_B_1> {
	public static final BuyingSession_B_3 cast = null;

	protected BuyingSession_B_3(org.scribble.runtime.session.SessionEndpoint<BuyingSession, B> se, boolean dummy) {
		super(se);
	}
