...
public interface Case_C_B_NotAllowed__B_Ok_Order<__Succ1 extends Succ_In_B_NotAllowed, __Succ2 extends Succ_In_B_Ok_Order> extends In_B_NotAllowed<__Succ1>, In_B_Ok_Order<__Succ2> {
	Branch_C_B_NotAllowed__B_Ok_Order<?, ?> cast = null;

	Branch_C_B_NotAllowed__B_Ok_Order.Branch_C_B_NotAllowed__B_Ok_Order_Enum getOp();
