...
public interface Case_C_P_Err_String__P_NotFound__P_Ok_Product<__Succ1 extends Succ_In_P_Err_String, __Succ2 extends Succ_In_P_NotFound, __Succ3 extends Succ_In_P_Ok_Product> extends In_P_Err_String<__Succ1>, In_P_NotFound<__Succ2>, In_P_Ok_Product<__Succ3> {
	Branch_C_P_Err_String__P_NotFound__P_Ok_Product<?, ?, ?> cast = null;

	Branch_C_P_Err_String__P_NotFound__P_Ok_Product.Branch_C_P_Err_String__P_NotFound__P_Ok_Product_Enum getOp();
