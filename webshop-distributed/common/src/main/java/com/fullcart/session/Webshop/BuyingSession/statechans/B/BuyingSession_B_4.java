...
import com.fullcart.session.Webshop.BuyingSession.statechans.B.ioifaces.Select_B_C_Err_String__U_GetOne_Long;

import java.io.IOException;

public final class BuyingSession_B_4 extends org.scribble.runtime.statechans.OutputSocket<BuyingSession, B> implements Select_B_C_Err_String__U_GetOne_Long<BuyingSession_B_1, BuyingSession_B_5> {
	...
	public BuyingSession_B_1 send(C role, Err op, java.lang.String arg0) throws org.scribble.main.ScribRuntimeException, IOException {
		super.writeScribMessage(role, BuyingSession.Err, arg0);
