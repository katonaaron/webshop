...
import com.fullcart.session.Webshop.BuyingSession.statechans.C.ioifaces.Handle_C_B_NotAllowed__B_NotFound__B_Ok_Order;

public interface BuyingSession_C_6_Handler extends Handle_C_B_NotAllowed__B_NotFound__B_Ok_Order<BuyingSession_C_1, BuyingSession_C_1, BuyingSession_C_1> {
	...
	@Override
    void receive(BuyingSession_C_1 schan, NotFound op) throws org.scribble.main.ScribRuntimeException, java.io.IOException, ClassNotFoundException;
