...
public interface Case_B_C_Bye__C_Cancel_Long_Order__C_Complete_Long_Order__C_Create_Long_List__C_GetAll__C_GetOne_Long<__Succ1 extends Succ_In_C_Bye, __Succ2 extends Succ_In_C_Cancel_Long_Order, __Succ3 extends Succ_In_C_Complete_Long_Order, __Succ4 extends Succ_In_C_Create_Long_List, __Succ5 extends Succ_In_C_GetAll, __Succ6 extends Succ_In_C_GetOne_Long> extends In_C_Bye<__Succ1>, In_C_Cancel_Long_Order<__Succ2>, In_C_Complete_Long_Order<__Succ3>, In_C_Create_Long_List<__Succ4>, In_C_GetAll<__Succ5>, In_C_GetOne_Long<__Succ6> {
	Branch_B_C_Bye__C_Cancel_Long_Order__C_Complete_Long_Order__C_Create_Long_List__C_GetAll__C_GetOne_Long<?, ?, ?, ?, ?, ?> cast = null;

	Branch_B_C_Bye__C_Cancel_Long_Order__C_Complete_Long_Order__C_Create_Long_List__C_GetAll__C_GetOne_Long.Branch_B_C_Bye__C_Cancel_Long_Order__C_Complete_Long_Order__C_Create_Long_List__C_GetAll__C_GetOne_Long_Enum getOp();
