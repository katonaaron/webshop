...
import com.fullcart.session.Webshop.UserSession.statechans.C.ioifaces.Branch_C_U_Created_User__U_Err_String__U_Ok_User;
import com.fullcart.session.Webshop.UserSession.statechans.C.ioifaces.Case_C_U_Created_User__U_Err_String__U_Ok_User;

public final class UserSession_C_6_Cases extends org.scribble.runtime.statechans.CaseSocket<UserSession, C> implements Case_C_U_Created_User__U_Err_String__U_Ok_User<UserSession_C_1, UserSession_C_1, UserSession_C_1> {
	public static final UserSession_C_6_Cases cast = null;
	public final UserSession_C_6.Branch_C_U_Created_User__U_Err_String__U_Ok_User_Enum op;
	private final org.scribble.runtime.message.ScribMessage m;

	protected UserSession_C_6_Cases(org.scribble.runtime.session.SessionEndpoint<UserSession, C> se, boolean dummy, UserSession_C_6.Branch_C_U_Created_User__U_Err_String__U_Ok_User_Enum op, org.scribble.runtime.message.ScribMessage m) {
		super(se);
		this.op = op;
		this.m = m;
	}
	...
	public UserSession_C_1 receive(U role, Created op, org.scribble.runtime.util.Buf<? super com.fullcart.dto.UserDTO> arg1) throws org.scribble.main.ScribRuntimeException, java.io.IOException, ClassNotFoundException {
		super.use();
		if (!this.m.op.equals(UserSession.Created)) {
			throw new org.scribble.main.ScribRuntimeException("Wrong branch, received: " + this.m.op);
		}
		arg1.val = (com.fullcart.dto.UserDTO) m.payload[0];
		return new UserSession_C_1(this.se, true);
	...
	public UserSession_C_1 receive(Created op, org.scribble.runtime.util.Buf<? super com.fullcart.dto.UserDTO> arg1) throws org.scribble.main.ScribRuntimeException, java.io.IOException, ClassNotFoundException {
		return receive(UserSession.U, op, arg1);
	}

	@SuppressWarnings("unchecked")
	public UserSession_C_1 receive(Created op) throws org.scribble.main.ScribRuntimeException, java.io.IOException, ClassNotFoundException {
		return receive(op, (org.scribble.runtime.util.Buf<com.fullcart.dto.UserDTO>) this.se.gc);
	}
	...
	@Override
	public Branch_C_U_Created_User__U_Err_String__U_Ok_User.Branch_C_U_Created_User__U_Err_String__U_Ok_User_Enum getOp() {
		return this.op;
	}
}
