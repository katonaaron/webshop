...
public final class BuyingSession_C_6_Cases extends org.scribble.runtime.statechans.CaseSocket<BuyingSession, C> implements Case_C_B_NotAllowed__B_NotFound__B_Ok_Order<BuyingSession_C_1, BuyingSession_C_1, BuyingSession_C_1> {
	public static final BuyingSession_C_6_Cases cast = null;
	public final BuyingSession_C_6.Branch_C_B_NotAllowed__B_NotFound__B_Ok_Order_Enum op;
	private final org.scribble.runtime.message.ScribMessage m;

	protected BuyingSession_C_6_Cases(org.scribble.runtime.session.SessionEndpoint<BuyingSession, C> se, boolean dummy, BuyingSession_C_6.Branch_C_B_NotAllowed__B_NotFound__B_Ok_Order_Enum op, org.scribble.runtime.message.ScribMessage m) {
		super(se);
		this.op = op;
		this.m = m;
	}
