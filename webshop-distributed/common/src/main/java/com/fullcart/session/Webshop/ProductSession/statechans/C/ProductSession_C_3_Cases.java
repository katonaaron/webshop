...
import com.fullcart.session.Webshop.ProductSession.statechans.C.ioifaces.Case_C_P_NotFound__P_Ok_Product;

public final class ProductSession_C_3_Cases extends org.scribble.runtime.statechans.CaseSocket<ProductSession, C> implements Case_C_P_NotFound__P_Ok_Product<ProductSession_C_1, ProductSession_C_1> {
	public static final ProductSession_C_3_Cases cast = null;
	public final ProductSession_C_3.Branch_C_P_NotFound__P_Ok_Product_Enum op;
	private final org.scribble.runtime.message.ScribMessage m;

	protected ProductSession_C_3_Cases(org.scribble.runtime.session.SessionEndpoint<ProductSession, C> se, boolean dummy, ProductSession_C_3.Branch_C_P_NotFound__P_Ok_Product_Enum op, org.scribble.runtime.message.ScribMessage m) {
		super(se);
		this.op = op;
		this.m = m;
	}
	...
	@Override
	public Branch_C_P_NotFound__P_Ok_Product.Branch_C_P_NotFound__P_Ok_Product_Enum getOp() {
		return this.op;
	}
}
