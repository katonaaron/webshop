...
import com.fullcart.session.Webshop.BuyingSession.statechans.B.ioifaces.Case_B_U_NotFound__U_Ok_User;

public final class BuyingSession_B_5_Cases extends org.scribble.runtime.statechans.CaseSocket<BuyingSession, B> implements Case_B_U_NotFound__U_Ok_User<BuyingSession_B_10, BuyingSession_B_6> {
	public static final BuyingSession_B_5_Cases cast = null;
	public final BuyingSession_B_5.Branch_B_U_NotFound__U_Ok_User_Enum op;
	private final org.scribble.runtime.message.ScribMessage m;

	protected BuyingSession_B_5_Cases(org.scribble.runtime.session.SessionEndpoint<BuyingSession, B> se, boolean dummy, BuyingSession_B_5.Branch_B_U_NotFound__U_Ok_User_Enum op, org.scribble.runtime.message.ScribMessage m) {
		super(se);
		this.op = op;
		this.m = m;
	}
	...
	public BuyingSession_B_10 receive(U role, NotFound op) throws org.scribble.main.ScribRuntimeException, java.io.IOException, ClassNotFoundException {
		super.use();
	...
	public BuyingSession_B_10 receive(NotFound op) throws org.scribble.main.ScribRuntimeException, java.io.IOException, ClassNotFoundException {
		return receive(BuyingSession.U, op);
	}

	@Override
	public Branch_B_U_NotFound__U_Ok_User.Branch_B_U_NotFound__U_Ok_User_Enum getOp() {
		return this.op;
	}
}
