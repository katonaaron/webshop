...
import com.fullcart.session.Webshop.BuyingSession.statechans.P.ioifaces.Select_P_B_NotFound__B_Ok_List;

import java.io.IOException;

public final class BuyingSession_P_2 extends org.scribble.runtime.statechans.OutputSocket<BuyingSession, P> implements Select_P_B_NotFound__B_Ok_List<BuyingSession_P_1, BuyingSession_P_1> {
	...
	public BuyingSession_P_1 send(B role, NotFound op) throws org.scribble.main.ScribRuntimeException, IOException {
