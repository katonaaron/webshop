...
import com.fullcart.session.Webshop.UserSession.statechans.U.ioifaces.Select_U_C_Err_String__C_Ok_User;

import java.io.IOException;

public final class UserSession_U_4 extends org.scribble.runtime.statechans.OutputSocket<UserSession, U> implements Select_U_C_Err_String__C_Ok_User<UserSession_U_1, UserSession_U_1> {
	public static final UserSession_U_4 cast = null;

	protected UserSession_U_4(org.scribble.runtime.session.SessionEndpoint<UserSession, U> se, boolean dummy) {
		super(se);
	}
