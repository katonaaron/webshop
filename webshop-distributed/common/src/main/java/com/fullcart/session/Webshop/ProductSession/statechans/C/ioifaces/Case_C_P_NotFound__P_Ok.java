...
public interface Case_C_P_NotFound__P_Ok<__Succ1 extends Succ_In_P_NotFound, __Succ2 extends Succ_In_P_Ok> extends In_P_NotFound<__Succ1>, In_P_Ok<__Succ2> {
	Branch_C_P_NotFound__P_Ok<?, ?> cast = null;

	Branch_C_P_NotFound__P_Ok.Branch_C_P_NotFound__P_Ok_Enum getOp();
