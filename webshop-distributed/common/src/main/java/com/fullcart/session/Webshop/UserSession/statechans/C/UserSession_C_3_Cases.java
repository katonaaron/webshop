...
import com.fullcart.session.Webshop.UserSession.statechans.C.ioifaces.Case_C_U_NotFound__U_Ok_User;

public final class UserSession_C_3_Cases extends org.scribble.runtime.statechans.CaseSocket<UserSession, C> implements Case_C_U_NotFound__U_Ok_User<UserSession_C_1, UserSession_C_1> {
	public static final UserSession_C_3_Cases cast = null;
	public final UserSession_C_3.Branch_C_U_NotFound__U_Ok_User_Enum op;
	private final org.scribble.runtime.message.ScribMessage m;

	protected UserSession_C_3_Cases(org.scribble.runtime.session.SessionEndpoint<UserSession, C> se, boolean dummy, UserSession_C_3.Branch_C_U_NotFound__U_Ok_User_Enum op, org.scribble.runtime.message.ScribMessage m) {
		super(se);
		this.op = op;
		this.m = m;
	}
	...
	@Override
	public Branch_C_U_NotFound__U_Ok_User.Branch_C_U_NotFound__U_Ok_User_Enum getOp() {
		return this.op;
	}
}
