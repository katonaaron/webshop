...
import com.fullcart.session.Webshop.BuyingSession.statechans.C.ioifaces.Select_C_B_Bye__B_Cancel_Long_Order__B_Complete_Long_Order__B_Create_Long_List__B_GetAll__B_GetOne_Long;

import java.io.IOException;

public final class BuyingSession_C_1 extends org.scribble.runtime.statechans.OutputSocket<BuyingSession, C> implements Select_C_B_Bye__B_Cancel_Long_Order__B_Complete_Long_Order__B_Create_Long_List__B_GetAll__B_GetOne_Long<EndSocket, BuyingSession_C_5, BuyingSession_C_6, BuyingSession_C_4, BuyingSession_C_2, BuyingSession_C_3> {
	...
	public BuyingSession_C_4 send(B role, Create op, java.lang.Long arg0, java.lang.Iterable arg1) throws org.scribble.main.ScribRuntimeException, IOException {
		super.writeScribMessage(role, BuyingSession.Create, arg0, arg1);

		return new BuyingSession_C_4(this.se, true);
	}

	public BuyingSession_C_5 send(B role, Cancel op, java.lang.Long arg0, com.fullcart.dto.OrderDTO arg1) throws org.scribble.main.ScribRuntimeException, IOException {
		super.writeScribMessage(role, BuyingSession.Cancel, arg0, arg1);

		return new BuyingSession_C_5(this.se, true);
	}

	public BuyingSession_C_6 send(B role, Complete op, java.lang.Long arg0, com.fullcart.dto.OrderDTO arg1) throws org.scribble.main.ScribRuntimeException, IOException {
		super.writeScribMessage(role, BuyingSession.Complete, arg0, arg1);
