...
public interface Case_B_P_NotFound__P_Ok_List<__Succ1 extends Succ_In_P_NotFound, __Succ2 extends Succ_In_P_Ok_List> extends In_P_NotFound<__Succ1>, In_P_Ok_List<__Succ2> {
	Branch_B_P_NotFound__P_Ok_List<?, ?> cast = null;

	Branch_B_P_NotFound__P_Ok_List.Branch_B_P_NotFound__P_Ok_List_Enum getOp();
